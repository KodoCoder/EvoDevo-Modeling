...
def export_bodys(body_blueprints, io_file, sim_num):
    ...
    """
    body_blueprints_file = io_file + 'b_bf_' + str(sim_num) + '.dat'
...
def export_joints(joint_blueprints, io_file, sim_num):
    ...
    """
    joint_blueprints_file = io_file + 'j_bf_' + str(sim_num) + '.dat'
...
def export_sensors(sensor_blueprints, io_file, sim_num):
    ...
    """
    sensor_blueprints_file = io_file + 's_bf_' + str(sim_num) + '.dat'
...
def export_ann(s2n_blueprint, n2n_blueprint, s2j_blueprint,
    ...
    """
    s2n_blueprint_file = io_file + 's2n_bf_' + str(sim_num) + '.dat'
    n2n_blueprint_file = io_file + 'n2n_bf_' + str(sim_num) + '.dat'
    s2j_blueprint_file = io_file + 's2j_bf_' + str(sim_num) + '.dat'
    n2j_blueprint_file = io_file + 'n2j_bf_' + str(sim_num) + '.dat'
